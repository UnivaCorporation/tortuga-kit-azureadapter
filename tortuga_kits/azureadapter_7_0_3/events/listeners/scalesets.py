...
class AzureScaleSetCreatedListener(AzureScaleSetListenerMixin, BaseListener):
    name = 'azure-scale-set-created-listener'
...
class AzureScaleSetUpdatedListener(AzureScaleSetListenerMixin, BaseListener):
    name = 'azure-scale-set-updated-listener'
...
class AzureScaleSetDeletedListener(AzureScaleSetListenerMixin, BaseListener):
    name = 'azure-scale-set-deleted-listener'
